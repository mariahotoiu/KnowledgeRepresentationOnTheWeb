...
def similarity(c1,c2):
    ...
    return union , intersect, intersect / float(union), sqrt(intersect * (intersect - 0.8)) / union, 2*intersect/ len(set(subjectsTp)) + len(set(subjectsFsq)), intersect/min(len(set(subjectsFsq)), len(set(subjectsTp)))
